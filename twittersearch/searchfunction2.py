...
#This function will get users twittersearch words
...
#This function will twittersearch your query in twitter
...
def searchfunction2(newsearchword1):
    ...
    #for tweet in (tweepy.Cursor(api.twittersearch, q=newsearchword1, cached=False, start=prev).items(20)):
    for tweet in api.search(q=newsearchword1, cached=False, start=prev, count=100):
        ...
        ####################The below commented lines will help to twittersearch for the most frequent terms######
        ...
        termsw = "click me... http://127.0.0.1:8000/twittersearch/results/"
